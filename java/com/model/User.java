...
public class User {
	public User(Long userId, String userName, String userEmailId, int age, String currentTimeOfWritingArticles,
			...
			int rating, int blocklisted, java.util.Date date, java.util.Date date2, java.util.Date date3, int rangeExample,
	...
	@Min(value=3,message="Invalid number of articles for review.Minimum should be greater than value ")
	...
	@CreditCardNumber(message="Invalid credit card number.It should not contain invalid number.")
